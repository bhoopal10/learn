...
<div class="well well-sm" >
    <p style="font-size:16px" class="pull-left"><strong>All Course</strong></p>
            ...
            foreach($course as $Course)
            {
                ...
                <div class="item  col-xs-12 col-lg-4">
                    <div class="thumbnail">
                        ...
                        <div class="caption">
                            <a href="<?php echo $this->url->get('course/viewCourse?courseID=').$Course['id'];?>">
                                <h4 class="group inner list-group-item-heading">
                                    <b><?php echo ucfirst($Course['name']); ?></b></h4>
                            </a>
                            <p class="group inner list-group-item-text" style="height:120px">
                                <?php echo substr($Course['description'],0,215); ?>
                                <a href="<?php echo $this->url->get('course/viewCourse?courseID=').$Course['id'];?>">
                                    Read more...
                                    </a>
                            </p>
                            <div class="row">
                                ...
                                <div class="col-xs-12 col-md-4">
                                    <a class="btn btn-success" href="<?php echo $this->url->get ('T_Buy/addCart?courseID=').$Course['id']; ?>">Add to cart</a>
                                </div>
                            </div>
                        </div>
                    </div>
